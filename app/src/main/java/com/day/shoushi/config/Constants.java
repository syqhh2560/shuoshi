package com.day.shoushi.config;
...
public class Constants {
	...
	// 保存参数文件夹名称
	public static final String SHARED_PREFERENCE_NAME = "day_choushi_prefs";
	...
	// 图片存储路径
	public static final String BASE_PATH = SD_PATH + "/day/shoushi/";
